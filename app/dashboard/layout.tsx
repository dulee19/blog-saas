    ...
    return (
        <section className="grid min-h-screen w-full md:grid-cols-[220px_1fr] lg:grid-cols-[280px_1fr]">
            <div className="hidden border-r dark:border-muted bg-muted/40 md:block">
                <div className="flex h-full max-w-screen flex-col gap-2">
                    <div className="flex h-14 items-center border-b dark:border-muted px-4 lg:h-[60px] lg:px-6">
                        ...
                        <Link href="/" className="flex items-center gap-2 font-semibold">
                            <Image
                                ...
                                height={40}
                            />
                            <h3 className="text-2xl">Blog <span className="text-primary">SaaS</span></h3>
                        </Link>
                    </div>

                    <div className="flex-1">
                        <nav className="grid items-start px-2 font-medium lg:px-4" role="nav">
                            <DashboardItems />
                        </nav>
                    </div>
                </div>
