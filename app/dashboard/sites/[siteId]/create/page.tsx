...
const ArticleCreation = ({ params }: { params: { siteId: string } }) => {
                ...
                <CardContent>
                    <form id={form.id} onSubmit={form.onSubmit} action={action} className="flex flex-col gap-6">
                        ...
                        <div className="grid gap-2">
                            ...
                            <Textarea key={fields.smallDescription.key} name={fields.smallDescription.name} defaultValue={fields.smallDescription.initialValue} className="h-32" placeholder="Small description for your blog article..." />
